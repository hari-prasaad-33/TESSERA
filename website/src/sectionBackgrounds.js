...
export const sectionBackgrounds = {
  howWeBuild: {
    ...
    opacity: 0.76,
    position: 'center 20%',
    filter: 'saturate(1.02) contrast(1.06) brightness(0.64)',
    baseTint: 'bg-[#18202c]',
    overlayClass:
      'bg-[linear-gradient(165deg,rgba(12,20,30,0.38)_0%,rgba(14,18,28,0.32)_45%,rgba(10,16,24,0.44)_100%)]',
  ...
  howWeBuildCont: {
    ...
    opacity: 0.66,
    position: 'center 30%',
    filter: 'saturate(0.98) contrast(1.05) brightness(0.58)',
    baseTint: 'bg-[#161e1c]',
    overlayClass:
      'bg-[linear-gradient(200deg,rgba(10,18,14,0.42)_0%,rgba(8,14,12,0.36)_50%,rgba(6,12,10,0.46)_100%)]',
