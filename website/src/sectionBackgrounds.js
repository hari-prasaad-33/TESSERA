...
/** Softer scrim for section 04 so it sits closer to section 05 brightness without losing legibility. */
export const contentLaneScrimSofter =
  'bg-[linear-gradient(90deg,rgba(0,0,0,0.30)_0%,rgba(0,0,0,0.16)_45%,rgba(0,0,0,0.04)_72%,transparent_100%)]';
...
export const sectionBackgrounds = {
  howWeBuild: {
    ...
    opacity: 0.82,
    position: 'center 20%',
    filter: 'saturate(0.95) contrast(1.06) brightness(0.70) hue-rotate(-8deg)',
    baseTint: 'bg-[#18242f]',
    overlayClass:
      'bg-[linear-gradient(165deg,rgba(14,22,36,0.34)_0%,rgba(16,24,38,0.28)_45%,rgba(10,18,32,0.38)_100%)]',
    vignetteClass: 'bg-[radial-gradient(ellipse_90%_70%_at_50%_0%,rgba(93,212,240,0.12),transparent_58%)]',
    contentLaneClass: contentLaneScrimSofter,
  },
  howWeBuildCont: {
    src: '/images/textures/lichen-rock.jpg',
    opacity: 0.74,
    position: 'center 30%',
    filter: 'saturate(1.05) contrast(1.06) brightness(0.68) hue-rotate(12deg)',
    baseTint: 'bg-[#132422]',
    overlayClass:
      'bg-[linear-gradient(200deg,rgba(8,26,28,0.36)_0%,rgba(10,22,24,0.30)_50%,rgba(6,18,20,0.40)_100%)]',
    vignetteClass: 'bg-[radial-gradient(ellipse_85%_60%_at_30%_0%,rgba(93,212,240,0.12),transparent_55%)]',
    contentLaneClass: contentLaneScrimSofter,
  },
  products: {
