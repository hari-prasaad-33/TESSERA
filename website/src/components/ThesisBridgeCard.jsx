export default function ThesisBridgeCard() {
  return (
    <div className="relative overflow-hidden rounded-[1.9rem] border border-white/12 bg-[linear-gradient(135deg,rgba(10,12,18,0.96),rgba(18,12,10,0.92))] p-6 shadow-[0_34px_90px_rgba(0,0,0,0.56)] sm:p-7 lg:p-8">
      ...
      <div className="relative grid gap-5 sm:grid-cols-[minmax(0,1.1fr)_minmax(15rem,0.9fr)] sm:items-end lg:grid-cols-[minmax(0,1fr)_minmax(16rem,0.8fr)]">
        ...
        <div className="grid gap-3 font-mono text-[10px] uppercase tracking-[0.24em]">
          <div className="rounded-[1.1rem] border border-white/10 bg-[#0a0a0a]/85 px-4 py-3 text-[#d7edf3]">Visible moves</div>
          <div className="rounded-[1.1rem] border border-white/10 bg-[#0a0a0a]/85 px-4 py-3 text-[#ffe1af]">Editable handoff</div>
          <div className="rounded-[1.1rem] border border-white/10 bg-[#0a0a0a]/85 px-4 py-3 text-[#d7edf3]">Artist in control</div>
        </div>
      </div>
    </div>
  );
