export default function ThesisBridgeCard() {
  return (
    <div className="relative px-1 py-3 sm:px-2 sm:py-4">
      ...
      <p className="texture-type-shadow-soft mt-3 max-w-xl text-sm leading-relaxed text-[#d0d7e4] sm:text-base">
        We use intelligence to remove friction, not authorship. The machine can suggest. The artist still decides.
      </p>
      <p className="mt-6 font-mono text-[10px] uppercase tracking-[0.26em] text-[#99a3b7]">
