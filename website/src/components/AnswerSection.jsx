      ...
      <div className="panel-shell relative z-10">
        ...
        <div className="grid gap-14 lg:min-h-[32rem] lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:items-end lg:gap-16">
          <div>
            ...
            <p className="texture-type-shadow-soft mt-5 max-w-[34rem] text-base leading-relaxed text-[#d5dbe7] sm:text-lg">
          ...
          <div className="lg:pl-4">
            <div className="border-l-2 border-[#ffb84d]/45 pl-6 sm:pl-8">
              ...
              <p className="texture-type-shadow-soft mt-5 text-lg leading-relaxed text-[#e8ecf4] sm:text-xl">
        ...
        <div className="relative z-20 -mb-20 mt-16 max-w-4xl sm:mt-20">
