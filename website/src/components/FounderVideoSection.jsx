  ...
  return (
    <section className="relative z-10 overflow-hidden">
      <div className="relative overflow-hidden rounded-[2rem] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(7,10,16,0.96))] px-6 py-8 sm:px-8 sm:py-10 lg:px-12 lg:py-12">
        <div className="absolute inset-0 opacity-[0.42] lg:opacity-[0.68]">
          <ModularGridIllustration className="h-full" />
        </div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(93,212,240,0.1),transparent_30%),radial-gradient(circle_at_82%_22%,rgba(255,184,77,0.16),transparent_32%),linear-gradient(90deg,rgba(7,10,16,0.96)_0%,rgba(7,10,16,0.9)_42%,rgba(7,10,16,0.62)_70%,rgba(7,10,16,0.84)_100%)]" />
