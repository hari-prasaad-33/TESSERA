...
export default function EarlyBelievers() {
  ...
  return (
    <section id="believers" className="relative z-10 border-t border-white/10 bg-[#11131c] px-6 py-24 md:px-10 lg:px-14 lg:py-28">
      <div className="panel-shell">
        ...
        <div className="max-w-2xl border-l-2 border-[#ffb84d]/35 pl-6 sm:pl-8">
          ...
          <p className="texture-type-shadow-soft mt-6 text-lg leading-relaxed text-[#c6cfdd] sm:text-xl">
            We are not selling anything yet. We are gathering the people who think the creative act is worth protecting. If that is
